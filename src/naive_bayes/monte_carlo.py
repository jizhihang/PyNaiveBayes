...
class MonteCarlo:
    ...
    def compute_likelihood(self, alpha, beta):
        ...
        log_likelihood += scipy.special.gammaln(alpha_sum)
        log_likelihood -= scipy.special.gammaln(alpha) * self._K
    ...
    def sample(self):
        ...
        for data_index in xrange(self._N):
            ...
            cluster_log_probability = numpy.log(self._cluster_counts + self._alpha_alpha);
